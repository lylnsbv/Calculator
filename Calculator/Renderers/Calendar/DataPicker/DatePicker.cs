namespace kssaiy.Renderers.Calendar
{
    using System;
    ...
    public class DatePicker : Control
    {
        ...
        [Editor(typeof(MonthCalendarCalendarUIEditor), typeof(System.Drawing.Design.UITypeEditor))]
        ...
        private static void DrawButton(Graphics g, Rectangle rect, ComboButtonState buttonState, bool enabled)
        {
            ...
            using (Bitmap arrow = kssaiy.Properties.Resources.ComboArrowDown)
            {
                if (enabled)
                {
                    g.DrawImage(arrow, r);

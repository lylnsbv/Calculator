    ...
    class RoundButton : Button
    {
      ...
      //  private Pen _blackPen = null;
        ...
        private void InitializeComponent()
        {
            ...
            this.MouseUp += new MouseEventHandler(this.RoundButton_MouseUp);
            this.MouseDown += new MouseEventHandler(this.RoundButton_MouseDown);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            path.AddEllipse(0, 0, ClientSize.Width-3, ClientSize.Height-3);
        ...
        private void DrawImage(Graphics g)
        {
            ...
            if (Image != null)
            {
                Rectangle rc = new Rectangle(new Point((this.Width - Image.Width-1) / 2, (this.Height-1 - Image.Height) / 2), new Size(Image.Width, Image.Height));
        ...
        {
            _pen.Color = GetDarkerColor(this.BackColor, 20);
            _brushInside.Color = GetDarkerColor(this.BackColor, 40);
            this.Invalidate();
        }

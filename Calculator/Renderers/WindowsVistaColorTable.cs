...
namespace kssaiy.Renderers
{
    ...
    public class WindowsVistaColorTable
    {
        ...
        {
            BackgroundNorth = Color.FromArgb(67, 144, 167);
            BackgroundSouth = Color.FromArgb(0, 10, 31);

            GlossyEffectNorth = Color.FromArgb(214,0x9A, 0xCD, 0x32);
            GlossyEffectSouth = Color.FromArgb(74, 0x8d, 0xc7, 0x8d);

            BackgroundBorder = Color.FromArgb(0x4e, 0x5e, 0x05);
            BackgroundGlow = Color.FromArgb(0x1d, 0x70, 0x1d);

            Text = Color.White;

            ButtonOuterBorder = Color.FromArgb(0x81, 0x96, 0x5B);
            ButtonInnerBorder = Color.FromArgb(0xC2, 0xCE, 0xBF);
            ButtonInnerBorderPressed = Color.FromArgb(0x4b, 0x4b, 0x4b);
            ButtonBorder = Color.FromArgb(0x0B, 0x0B, 0x03);
            ...
            Glow = Color.FromArgb(0x30, 0xCE, 0x43);
            DropDownArrow = Color.White;

            MenuHighlight = Color.FromArgb(0x62, 0xb4, 0x13);
            ...
            CheckedGlow = Color.FromArgb(0x57, 0xEF, 0x69);
            CheckedGlowHot = Color.FromArgb(0x70, 0xFF, 0x88);
            CheckedButtonFill = Color.FromArgb(0x1D, 0x9E, 0x18);
            CheckedButtonFillHot = Color.FromArgb(0x0F, 0xBF, 0x1B);
